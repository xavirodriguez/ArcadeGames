...
export class ArkanoidGame extends BaseGame<ArkanoidStateComponent, ArkanoidInput, ArkanoidComponentRegistry, ArkanoidEventRegistry, ArkanoidBlueprintMap> {
  ...
  protected override async onRegisterSystems(): Promise<void> {
    ...
    // TODO(refactor): código duplicado detectado (bloque) con pong/PongGame.ts:113-119. Considerar extraer a función compartida. Ref: 2732579c
    ...
    this.blueprints.register("paddle", // TODO(refactor): código duplicado detectado (bloque) con pong/PongGame.ts:181-188. Considerar extraer a función compartida. Ref: 304dbc76
    {
      spawn: (world, entity, _args: {}) => {
        const config = world.getResource<ArkanoidConfig>("GameConfig") || DEFAULT_ARKANOID_CONFIG;
    ...
    // TODO(refactor): código duplicado detectado (bloque) con pong/PongGame.ts:266-275. Considerar extraer a función compartida. Ref: fdef5ea1
  ...
  protected override async onInitializeEntities(): Promise<void> {
    ...
    try {
      ...
      // TODO(refactor): código duplicado detectado (bloque) con pong/PongGame.ts:278-298. Considerar extraer a función compartida. Ref: c82d905a

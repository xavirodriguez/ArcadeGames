  ...
  return (
    ...
    >
      <button
        ...
        className={`flex flex-col p-3 rounded-lg border-2 w-48 shadow-lg transition-transform transition-shadow duration-200 text-left focus:outline-none focus:ring-2 focus:ring-cyan-300 ${
          config.styles
        } ${
          isSelected

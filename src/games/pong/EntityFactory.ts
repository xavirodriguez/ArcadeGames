...
// We can just define the CollisionLayers local mapping or import from @tiny-aster/core if it has it.
// Let's check packages/core/src/index.ts to see if CollisionLayers is exported.
// Yes, it was exported in packages/core/src/index.ts: CollisionLayers.

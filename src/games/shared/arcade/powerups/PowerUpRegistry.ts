...
export const COMMON_POWERUP_EFFECTS: Record<string, IPowerUpEffect> = {
  speed_boost: {
    apply(world: World<any>, playerEntity: number): void {
      if (world.hasComponent(playerEntity, "Velocity" as any)) {
        world.mutateComponent(playerEntity, "Velocity" as any, (v: any) => {
          v.vx *= 1.5;
          v.vy *= 1.5;
        });
      }
  ...
  shield: {
    apply(world: World<any>, playerEntity: number): void {
      if (!world.hasComponent(playerEntity, "Invulnerable" as any)) {
        world.getCommandBuffer().addComponent(playerEntity, {
          type: "Invulnerable",
          remaining: 5.0
        });
      } else {
        world.mutateComponent(playerEntity, "Invulnerable" as any, (inv: any) => {
  ...
  extra_life: {
    apply(world: World<any>): void {
      if (world.getSingleton("GameState" as any) !== undefined) {

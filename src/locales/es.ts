export const es = {
  ...
  campaign: {
    title: "CAMPAÑA HISTORIA",
    loading_minigame: "Cargando minijuego ({gameId})...",
    initializing: "Inicializando Campaña...",
    save_success: "¡Campaña guardada con éxito!",
    load_success: "¡Campaña cargada con éxito!",
    no_game_loaded: "Sin juego activo cargado",
    error_loading: "Error al cargar minijuego",
    retry: "Reintentar",
    restart_campaign: "Reiniciar Campaña",
    completed_title: "Campaña Completada",
    debug_narrative: "Depuración Narrativa",
